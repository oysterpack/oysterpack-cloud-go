...
// MessageProcessorEngine runs in a background goroutine. It receive incoming messages from the channel and routes them
// to message handlers based on channel and message type.
...
func (a *MessageProcessorEngine) IsMessageTypeSupported(channel Channel, msgType MessageType) bool {
	return a.Handler(channel, msgType) != nil
}
